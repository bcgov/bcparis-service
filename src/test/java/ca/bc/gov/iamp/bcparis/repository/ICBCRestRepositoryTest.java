...
public class ICBCRestRepositoryTest {
    ...
    public void request_details_success() {
        ...
        final String icbcResponse = repo.requestDetails(BCPARISTestUtil.getMessageDriverDL(),
                IMSRequest.builder().build());
    ...
    public void request_details_mqmd_messageId() {
        ...
        Assert.assertEquals("414D5120434251332020202020202020D9BF035D85206E23",
                results.get("auditTransactionId").get(0));
    }
    ...
    public void request_details_mqmd_correlationId() {
        ...
        Assert.assertEquals("414D5120424D565133564943202020205D0AD28120386102",
                results.get("auditTransactionId").get(0));
    }
