...
public class MessageTransformTest {
	...
	public void extract_CDATA_success() {
		...
		Assert.assertEquals("RE: 0509\nHC BC40940\nBC41027", list.get(6));
		Assert.assertEquals("SNME:WISKIN", list.get(7));
		Assert.assertEquals("G1:TOMAS", list.get(8));
		Assert.assertEquals("G2:GEORGE", list.get(9));
		Assert.assertEquals("G3:ALPHONSE", list.get(10));
		Assert.assertEquals("DOB:20020325", list.get(11));
		Assert.assertEquals("2019051520054820190515200548", list.get(12));
	}
	...
	public void extract_CDATA_escaped_success() {
		...
		Assert.assertEquals("2019051520054820190515200548", list.get(2));
	}
