...
public class MessageTransformTest {
	...
	public void extract_CDATA_success() {
		...
		Assert.assertEquals("SNME:WISKIN/G1:TOMAS/G2:GEORGE/G3:ALPHONSE/DOB:20020325", list.get(10));
		Assert.assertEquals(EMPTY_LINE, list.get(11));
		Assert.assertEquals("2019051520054820190515200548", list.get(12));
	}
	
	@Test
	public void extract_CDATA_escaped_success() {
		String message = "FROM:BC41127SNME:WISKIN/DOB:20020325\n\n2019051520054820190515200548";
		...
		Assert.assertEquals("FROM:BC41127", list.get(0));
		Assert.assertEquals("SNME:WISKIN/DOB:20020325", list.get(1));
